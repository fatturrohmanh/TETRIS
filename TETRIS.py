...
while True:
    ...
    #draw Title
    sc.blit(title_tetris, (350, 30))
    sc.blit(title_score, (370, 460))
    sc.blit(font.render(str(score), True, pygame.Color('white')), (390, 500))
    sc.blit(title_record, (370, 380))
    sc.blit(font.render(record, True, pygame.Color('gold')), (390, 420))
